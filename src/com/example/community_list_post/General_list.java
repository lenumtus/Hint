...
public class General_list extends Fragment {
    ...
    LinearLayout layout , listview_view ;
    RefreshableListView listView ;
    List<post> postList ;
    DBController db; 
    int categoryid ;
    TextView titlelist;
    AppController controlimages;
    @Override
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
    	super.onActivityCreated(savedInstanceState);
    	 ...
    	 controlimages = new AppController();
          ...
          localizationintent = new Intent(this.getActivity(), localisationservice.class);
   	    ...
   	    listview_view = (LinearLayout)getActivity().findViewById(R.id.listview_view);
   	      ///////////////////////////////// test list content ///////////////
   	 titlelist= (TextView) getActivity().findViewById(R.id.titlelist);
	      titlelist.setText("General");
   	            thread.start(); 
...
//   					Toast.makeText(getActivity(), "autorefresh", Toast.LENGTH_LONG).show(); 
    	...
    	Thread thread = new Thread() {
            ...
            public void run() {
          	   ...
          	   try {
               	...
               	layout.setVisibility(View.VISIBLE);
               	listview_view.setVisibility(View.GONE);
               	getActivity().startService(serviceIntent);
             	     //////////////////////// load data ////////////////////////////  
               	postList = db.getAllposts1(categoryid); 
             	resetadapter();
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                    	...
                    	listview_view.setVisibility(View.VISIBLE);
                        listView.setAdapter(adapter);
