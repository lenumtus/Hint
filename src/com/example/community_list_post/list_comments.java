...
public class list_comments extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.comments_list, container, false);
          ...
          layout = (LinearLayout)getActivity().findViewById(R.id.progressbar_view);
   		//////////////////////// start service ///////////////////////////
   	     ...
   	     //////////////////////// load data ////////////////////////////
   	      ...
   	      commentList = db.getAllcomments();
   	      adapter = new listcommentadapter(this.getActivity(), commentList);
...
//		 List<post> postList = db.getAllposts1();
